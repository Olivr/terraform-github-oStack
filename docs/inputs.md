...
| <a name="module_global_ops_backend_tfe"></a> [global_ops_backend_tfe](#module_global_ops_backend_tfe) | Olivr/backend/tfe | n/a |
| <a name="module_global_ops_repo_github"></a> [global_ops_repo_github](#module_global_ops_repo_github) | Olivr/repo/github | n/a |
...
| <a name="input_dev_settings"></a> [dev_settings](#input_dev_settings) | Used for expert users or internal oStack developers. | `map(any)` | <pre>{<br> "module_cluster_init": "Olivr/init-cluster/flux"<br>}</pre> | no |
